...
class __TwigTemplate_936f0b00f9696a79abb4dfc5cc999c98 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        if ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 7, $this->source); })()), "creator", [], "any", false, false, false, 7) == CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 7, $this->source); })()), "user", [], "any", false, false, false, 7))) {
            // line 8
            yield "        ";
...
";
    ...
    {
        return array (  107 => 12,  101 => 10,  95 => 8,  93 => 7,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% endblock %}
", "article/edit.html.twig", "C:\\Users\\as1680\\Desktop\\Projects Old\\My Projects\\projects\\article_management\\templates\\article\\edit.html.twig");
    }
}
