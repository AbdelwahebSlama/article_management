...
class __TwigTemplate_2def50f870a2486063673c2d277ee842 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["transport"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["event"]) {
                ...
                if ( !CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", true, true, false, 111)) {
                    ...
                    // line 135
                    $context['_parent'] = $context;
                    $context['_seq'] = CoreExtension::ensureTraversable(Twig\Extension\CoreExtension::arrayFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 135, $this->source); })()), "headers", [], "any", false, false, false, 135), "all", [], "any", false, false, false, 135), function ($__header__) use ($context, $macros) { $context["header"] = $__header__; return !CoreExtension::inFilter((((CoreExtension::getAttribute($this->env, $this->source, $context["header"], "name", [], "any", true, true, false, 135) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, $context["header"], "name", [], "any", false, false, false, 135)))) ? (CoreExtension::getAttribute($this->env, $this->source, $context["header"], "name", [], "any", false, false, false, 135)) : ("")), ["Subject", "From", "To"]); }));
                    foreach ($context['_seq'] as $context["_key"] => $context["header"]) {
                        // line 136
                        yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["header"], "toString", [], "any", false, false, false, 136), "html", null, true);
                        yield "
";
                    }
                    ...
                    if (CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "htmlBody", [], "any", true, true, false, 142)) {
                        ...
                        if ( !(null === (isset($context["htmlBody"]) || array_key_exists("htmlBody", $context) ? $context["htmlBody"] : (function () { throw new RuntimeError('Variable "htmlBody" does not exist.', 145, $this->source); })()))) {
                            ...
                            // line 151
                            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 151, $this->source); })()), "base64Encode", [(isset($context["htmlBody"]) || array_key_exists("htmlBody", $context) ? $context["htmlBody"] : (function () { throw new RuntimeError('Variable "htmlBody" does not exist.', 151, $this->source); })())], "method", false, false, false, 151), "html", null, true);
                            yield "\"
                            ...
                            if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 162, $this->source); })()), "htmlCharset", [], "method", false, false, false, 162)) {
                                // line 163
                                yield Twig\Extension\EscaperExtension::escape($this->env, Twig\Extension\CoreExtension::convertEncoding((isset($context["htmlBody"]) || array_key_exists("htmlBody", $context) ? $context["htmlBody"] : (function () { throw new RuntimeError('Variable "htmlBody" does not exist.', 163, $this->source); })()), "UTF-8", CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 163, $this->source); })()), "htmlCharset", [], "method", false, false, false, 163)), "html", null, true);
                            } else {
                                // line 165
                                yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["htmlBody"]) || array_key_exists("htmlBody", $context) ? $context["htmlBody"] : (function () { throw new RuntimeError('Variable "htmlBody" does not exist.', 165, $this->source); })()), "html", null, true);
                            }
                            // line 167
                            yield "</pre>
                                                        </div>
                        ...
                        if ( !(null === (isset($context["textBody"]) || array_key_exists("textBody", $context) ? $context["textBody"] : (function () { throw new RuntimeError('Variable "textBody" does not exist.', 172, $this->source); })()))) {
                            ...
                            if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 177, $this->source); })()), "textCharset", [], "method", false, false, false, 177)) {
                                // line 178
                                yield Twig\Extension\EscaperExtension::escape($this->env, Twig\Extension\CoreExtension::convertEncoding((isset($context["textBody"]) || array_key_exists("textBody", $context) ? $context["textBody"] : (function () { throw new RuntimeError('Variable "textBody" does not exist.', 178, $this->source); })()), "UTF-8", CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 178, $this->source); })()), "textCharset", [], "method", false, false, false, 178)), "html", null, true);
                            } else {
                                // line 180
                                yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["textBody"]) || array_key_exists("textBody", $context) ? $context["textBody"] : (function () { throw new RuntimeError('Variable "textBody" does not exist.', 180, $this->source); })()), "html", null, true);
                            }
                            // line 182
                            yield "</pre>
                                                        </div>
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["attachment"]) {
                            ...
                            // line 188
                            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 188), "html", null, true);
                            yield "</h3>
                                                        <div class=\"tab-content\">
                                                            <pre class=\"prewrap\" style=\"max-height: 600px\">";
                            // line 190
                            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["attachment"], "toString", [], "method", false, false, false, 190), "html", null, true);
                            yield "</pre>
                                                        </div>
                                                    </div>
                                                ";
                    ...
                    yield "                                            <div class=\"tab\">
                                                ...
                                                <div class=\"tab-content\">
                                                    <pre class=\"prewrap\" style=\"max-height: 600px\">";
                    // line 198
                    yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 198, $this->source); })()), "body", [], "method", false, false, false, 198), "asDebugString", [], "method", false, false, false, 198), "html", null, true);
                    yield "</pre>
                                                </div>
                                            </div>
                                            <div class=\"tab\">
                                                ...
                                                <div class=\"tab-content\">
                                                    <pre class=\"prewrap\" style=\"max-height: 600px\">";
                    // line 204
                    yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 204, $this->source); })()), "toString", [], "method", false, false, false, 204), "html", null, true);
                    yield "</pre>
                                                </div>
                                            </div>
                                        </div>
    ...
    {
        return array (  518 => 214,  509 => 210,  500 => 204,  491 => 198,  486 => 195,  483 => 194,  465 => 190,  460 => 188,  457 => 187,  439 => 186,  433 => 182,  430 => 180,  427 => 178,  425 => 177,  420 => 173,  417 => 172,  414 => 171,  408 => 167,  405 => 165,  402 => 163,  400 => 162,  387 => 151,  380 => 146,  377 => 145,  374 => 144,  372 => 143,  370 => 142,  363 => 137,  355 => 136,  351 => 135,  344 => 131,  338 => 128,  331 => 124,  323 => 118,  321 => 117,  315 => 114,  312 => 113,  310 => 112,  308 => 111,  302 => 108,  299 => 107,  296 => 106,  292 => 105,  288 => 103,  284 => 102,  276 => 97,  268 => 92,  263 => 89,  257 => 85,  255 => 84,  250 => 81,  247 => 80,  237 => 79,  225 => 76,  219 => 73,  216 => 72,  214 => 71,  208 => 68,  204 => 67,  201 => 66,  198 => 65,  188 => 64,  141 => 28,  131 => 27,  117 => 23,  114 => 22,  108 => 19,  101 => 15,  97 => 13,  95 => 12,  92 => 11,  86 => 9,  83 => 8,  80 => 7,  78 => 6,  75 => 5,  72 => 4,  62 => 3,  39 => 1,);
    }
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "C:\\Users\\as1680\\Desktop\\Projects Old\\My Projects\\projects\\article_management\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\mailer.html.twig");
    }
}
