...
class __TwigTemplate_efc59d291c33e76ae40569f33ccfe56f extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"row mb-4\">
      <div class=\"col-4\">
        ...
        yield "\" class=\"link-primary\">back to list</a>
        </div>
    </div>
...
";
    ...
    {
        return array (  105 => 16,  97 => 11,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
  ...
  <div class=\"row mb-4\">
      <div class=\"col-4\">
          {{ include('article/_form.html.twig') }}
            ...
            <a href=\"{{ path('app_article_index') }}\" class=\"link-primary\">back to list</a>
        </div>
    </div>

{% endblock %}
", "article/new.html.twig", "C:\\Users\\as1680\\Desktop\\Projects Old\\My Projects\\projects\\article_management\\templates\\article\\new.html.twig");
    }
}
